...
#ifndef CEPH_GENERICCSTOREBACKEDN_H
#define CEPH_GENERICCSTOREBACKEDN_H

#include "CStore.h"

class SloppyCRCMap;

class GenericCStoreBackend : public CStoreBackend {
private:
  bool ioctl_fiemap;
  bool seek_data_hole;
...
public:
  explicit GenericCStoreBackend(CStore *fs);
  virtual ~GenericCStoreBackend() {}
