...
#ifndef CEPH_BTRFSCSTOREBACKEDN_H
#define CEPH_BTRFSCSTOREBACKEDN_H

#if defined(__linux__)
#include "GenericCStoreBackend.h"

class BtrfsCStoreBackend : public GenericCStoreBackend {
private:
...
public:
  explicit BtrfsCStoreBackend(CStore *fs);
  ~BtrfsCStoreBackend() {}
  const char *get_name() {
    return "btrfs";
  }
