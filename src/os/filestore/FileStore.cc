...
FileStore::FileStore(const std::string &base, const std::string &jdev, osflagbits_t flags, const char *name, bool do_update) :
  ...
  op_tp(g_ceph_context, "FileStore::op_tp", "tp_fstore_op", g_conf->filestore_op_threads_per_shard * g_conf->filestore_op_num_shards),
  op_wq(g_conf->filestore_op_num_shards, this, g_conf->filestore_op_thread_timeout,
