...
int LevelDBStore::init(ostream &out, bool create_if_missing)
{
  ...
  options.write_buffer_size = g_conf->osd_leveldb_write_buffer_size;
  options.cache_size = g_conf->osd_leveldb_cache_size;
  options.block_size = g_conf->osd_leveldb_block_size;
  options.bloom_size = g_conf->osd_leveldb_bloom_size;
  options.compression_enabled = g_conf->osd_leveldb_compression;
  options.paranoid_checks = g_conf->osd_leveldb_paranoid;
  options.max_open_files = g_conf->osd_leveldb_max_open_files;
  options.log_file = g_conf->osd_leveldb_log;
