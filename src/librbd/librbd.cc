...
namespace librbd {
  ...
  */
                                   ...
                                   uint64_t *mismatch_off, int op_flags)
  {
    ...
    int r = ictx->aio_work_queue->compare_and_write(ofs, len, bufferlist{cmp_bl},
                                   ...
                                   int op_flags)
  {
    ...
    ictx->aio_work_queue->aio_compare_and_write(get_aio_completion(c), off, len,
                                         ...
                                         int op_flags)
{
  ...
  int r = ictx->aio_work_queue->compare_and_write(ofs, len, std::move(cmp_bl),
                                             ...
                                             int op_flags)
{
  ...
  bufferlist bl;
  bl.push_back(create_write_raw(ictx, buf, len));
  ictx->aio_work_queue->aio_compare_and_write(get_aio_completion(comp), off, len,
